...
public class Tab1Contacts extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Se agrega el recycleview a la vista de la tab de contactos
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstContacts.add(new Contact("Desgraciado 1","22222222",R.drawable.contact_pp_pop));
        lstContacts.add(new Contact("Desgraciado 2","88888888",R.drawable.contact_pp_pop));
        lstContacts.add(new Contact("Desgraciado 3","77777777",R.drawable.contact_pp_pop));
